...
abstract class ImageUtils {
  companion object {
    ...
    private fun decodeExifOrientation(orientation: Int): Matrix {
      ...
      when (orientation) {
        android.media.ExifInterface.ORIENTATION_NORMAL, android.media.ExifInterface.ORIENTATION_UNDEFINED -> Unit
    ...
    fun setExifOrientation(
      ...
      exif.setAttribute(
        android.media.ExifInterface.TAG_ORIENTATION, value
      )
      exif.saveAttributes()
    }
      ...
      val transformation =
        decodeExifOrientation(
          exif.getAttributeInt(
            android.media.ExifInterface.TAG_ORIENTATION, android.media.ExifInterface.ORIENTATION_ROTATE_90
          )
        )
